...
public class RVUI3 extends AbstractTableModel implements Parametres, RXXX{
  ...
  public RVUI3(String sAno, String sOficina) {
        int files;
        int cols;

        String query11 = "drop table if exists tempVUI3a";

        String query2 = "CREATE TABLE tempVUI3a (asuntos TEXT) ";
        query2 += "SELECT ano,dia,descripcion,tipo,peticionario,depto,pub,num,asuntos ";
        query2 += "FROM vinf,oficinas ";
        query2 += "WHERE ((ano=\"" +sAno+ "\") AND (oficinas.descripcion=\"" +sOficina+ "\") AND (vinf.oficina=oficinas.codigo)) ";
        query2 += "ORDER BY depto";

        String query3 ="ALTER TABLE tempVUI3a ADD suma int(5) unsigned default '0'";
        //String query3a = "ALTER TABLE tempVUI3a MODIFY peticionario varchar(20)";
        //String query3b = "ALTER TABLE tempVUI3a MODIFY asuntos varchar(55)";
        ...
        try {
                ...
                //Statement sentencia3b = con.createStatement();
                //sentencia3b.execute(query3b);
  ...
  public Connection getConnection() throws SQLException {
    ...
    public String getColumnName(int columnIndex) {
      ...
      switch (columnIndex) {
        ...
        case 4: nomCol="peticionario";break;
        case 5: nomCol="depto";break;
        case 6: nomCol="pub";break;
        case 7: nomCol="num";break;
        case 8: nomCol="asuntos";break;
