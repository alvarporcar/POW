...
public class RAT3 extends AbstractTableModel implements Parametres, RXXX {
  ...
  public RAT3(String sMes, String sAno) {
        int files;
        int cols;

        String query11 = "drop table if exists tempAT3 ";
        String query22 = "drop table if exists tempAT3a ";

        String query1 = "create table tempAT3 ";
        query1 += "select ano, mes, oficinas.descripcion as oficina,tipo_asist_tecnica.descripcion as tipo,count(*) as num ";
        ...
        String query2 = "CREATE TABLE `tempAT3a` ( ";
        ...
        String query4 = "select * from tempAT3";
        ...
        try {
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempAT3a values (\""+sAno+"\",\""+sMes+"\",\""+tipo+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+")";
