...
public class RAT10 extends AbstractTableModel implements Parametres, RXXX {
  ...
  public RAT10(String sAno, String sAnoFinal) {
        int files;
        int cols;


       
        String query = " SELECT oficinas.descripcion as ofisam,ano,count(*) as total";
        query += " FROM asist_tecnica,oficinas";
        query += " WHERE ((ano BETWEEN \"" +sAno+ "\" AND \""+sAnoFinal+"\") AND (oficinas.codigo=asist_tecnica.oficina))";
