...
public class RVUI2 extends AbstractTableModel implements Parametres, RXXX{
  ...
  public RVUI2(String sMes, String sAno) {
        int files;
        int cols;
        ...
        query1 += "select ano, mes, depto, descripcion AS oficina,sum(num) as num ";
        query1 += "from vinf,oficinas ";
        query1 += "where (ano=\""+sAno+"\") and (mes=\""+sMes+"\") and (vinf.oficina=oficinas.codigo) ";
        ...
        query2 += "`of_benassal` tinyint(5) unsigned default '0', ";
        query2 += "`of_montanejos` tinyint(5) unsigned default '0', ";
        query2 += "`of_morella` tinyint(5) unsigned default '0', ";
        query2 += "`of_onda` tinyint(5) unsigned default '0', ";
        query2 += "`of_segorbe` tinyint(5) unsigned default '0', ";
        query2 += "`of_traiguera` tinyint(5) unsigned default '0', ";
        query2 += "`publicos` tinyint(5) unsigned default '0', ";
        query2 += "`privados` tinyint(5) unsigned default '0' ";
        query2 += ") ";
        ...
        try {
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempVUI2a values (\""+sAno+"\",\""+sMes+"\",\""+departament+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+",0,0)";
                ...
                String query8 = "insert into tempVUI2a values (\""+sAno+"\",\""+sMes+"\",\"DIPUTACION\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+",0,0)";
                ...
                query9 += "from vinf ";
                query9 += "where (ano=\""+sAno+"\") and (mes=\""+sMes+"\") and (pub=\"N\") ";
  ...
  public Connection getConnection() throws SQLException {
    ...
    public String getColumnName(int columnIndex) {
      ...
      switch (columnIndex) {
        ...
        case 9: nomCol="publicos";break;
        case 10: nomCol="privados";break;
        case 11: nomCol="total";break;
      }
      return nomCol;
    }
