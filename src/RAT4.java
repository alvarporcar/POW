...
public class RAT4 extends AbstractTableModel implements Parametres, RXXX {
  ...
  public RAT4(String sMes, String sAno) {
        int files;
        int cols;

        String query1 = "select ano, mes, oficinas.descripcion as oficina,sum(proyectado) as proyectado,sum(certificado) as certificado, ";
  ...
  public Connection getConnection() throws SQLException {
    ...
    public String getColumnName(int columnIndex) {
      ...
      switch (columnIndex) {
        ...
        case 3: nomCol="proyectado";break;
        case 4: nomCol="certificado";break;
        case 5: nomCol="peritado";break;
        case 6: nomCol="planos";break;
      }
      return nomCol;
    }
