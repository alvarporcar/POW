...
public class RAT6 extends AbstractTableModel implements Parametres, RXXX {
  ...
  public RAT6(String sAno) {
        int files;
        int cols;

        String query11 = "drop table if exists tempAT6 ";
        String query22 = "drop table if exists tempAT6a ";

        String query1 = "create table tempAT6 ";
        query1 += "select ano,oficinas.descripcion as oficina,tipo_asist_tecnica.descripcion as tipo,count(*) as num ";
        query1 += "from asist_tecnica,tipo_asist_tecnica,oficinas ";
        query1 += "where (ano=\""+sAno+"\") and (asist_tecnica.oficina=oficinas.codigo) ";
        query1 += "and (asist_tecnica.tipo=tipo_asist_tecnica.abreviatura) ";
        query1 += "group by tipo,oficina ";
        query1 += "order by tipo";

        String query2 = "CREATE TABLE `tempAT6a` ( ";
        ...
        String query3 = "Select * from tipo_asist_tecnica";

        String query4 = "select * from tempAT6";
        ...
        try {
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempAT6a values (\""+sAno+"\",\""+tipo+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+")";
