...
public class RAJ3 extends AbstractTableModel implements Parametres, RXXX{
  ...
  public RAJ3(String sMes, String sAno) {
        int files;
        int cols;

        String query11 = "drop table if exists tempAJ3 ";
        String query22 = "drop table if exists tempAJ3a ";

        String query1 = "create table tempAJ3 ";
        query1 += "select ano, mes, oficinas.descripcion as oficina,tipo_asist.descripcion as tipo,sum(num) as num ";
        query1 += "from asist_juridica,oficinas,tipo_asist ";
        query1 += "where (ano=\""+sAno+"\") and (mes=\""+sMes+"\") and (asist_juridica.oficina=oficinas.codigo) ";
        query1 += "and (asist_juridica.tipo=tipo_asist.abreviatura) ";
        query1 += "group by tipo,oficina ";
        query1 += "order by tipo";

        String query2 = "CREATE TABLE `tempAJ3a` ( ";
        ...
        String query3 = "Select * from tipo_asist";

        String query4 = "select * from tempAJ3";
        ...
        try {
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempAJ3a values (\""+sAno+"\",\""+sMes+"\",\""+tipo+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+")";
