...
public class RAA2 extends AbstractTableModel implements Parametres, RXXX{
  ...
  public RAA2(String sMes, String sAno) {
        int files;
        int cols;
        ...
        query1 += "where (ano=\""+sAno+"\") and (mes=\""+sMes+"\") and (asist_admva.oficina=oficinas.codigo) ";
        ...
        try {
                ...
                query7 += " WHERE (ano=\""+sAno+"\") AND (mes=\""+sMes+"\") AND (asist_admva.oficina=oficinas.codigo)";
                ...
                String query8 = "insert into tempAA2a values (\""+sAno+"\",\""+sMes+"\",\" ENT. LOCALES\","+eximits1+","+eximits2+","+eximits3+","+eximits4+","+eximits5+","+eximits6+")";
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempAA2a values (\""+sAno+"\",\""+sMes+"\",\""+tipo+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+")";
