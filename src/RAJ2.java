...
public class RAJ2 extends AbstractTableModel implements Parametres, RXXX{
  ...
  public RAJ2(String sMes, String sAno) {
        int files;
        int cols;

        String query11 = "drop table if exists tempAJ2 ";
        String query22 = "drop table if exists tempAJ2a ";

        String query1 = "create table tempAJ2 ";
        query1 += "select ano, mes, descripcion as oficina,materia,sum(num) as num ";
        ...
        String query2 = "CREATE TABLE `tempAJ2a` ( ";
        ...
        String query4 = "select * from tempAJ2";
        ...
        try {
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempAJ2a values (\""+sAno+"\",\""+sMes+"\",\""+materia+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+")";
