...
public class RAT5 extends AbstractTableModel implements Parametres, RXXX{
  ...
  public RAT5(String sAno) {
        int files;
        int cols;

        String query11 = "drop table if exists tempAT5 ";
        String query22 = "drop table if exists tempAT5a ";

        String query1 = "create table tempAT5 ";
        query1 += "select ano, oficinas.descripcion as oficina,tipo_mat_tecnica.descripcion as materia,count(*) as num ";
        ...
        String query2 = "CREATE TABLE `tempAT5a` ( ";
        ...
        String query4 = "select * from tempAT5";
        ...
        try {
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempAT5a values (\""+sAno+"\",\""+materia+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+")";
