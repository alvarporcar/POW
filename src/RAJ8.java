...
public class RAJ8 extends AbstractTableModel implements Parametres, RXXX {
  ...
  public RAJ8(String sAno, String sAnoFinal) {
        int files;
        int cols;
        ...
        query += " WHERE ((ano BETWEEN \"" +sAno+ "\" AND \""+sAnoFinal+"\") AND (oficinas.codigo=asist_juridica.oficina))";
        query += " AND (tipo in (\"VR\",\"VP\",\"TR\",\"TP\"))";
