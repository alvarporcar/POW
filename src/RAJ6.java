...
public class RAJ6 extends AbstractTableModel implements Parametres, RXXX {
  ...
  public RAJ6(String sAno) {
        int files;
        int cols;

        String query11 = "drop table if exists tempAJ6 ";
        String query22 = "drop table if exists tempAJ6a ";

        String query1 = "create table tempAJ6 ";
        query1 += "select ano,oficinas.descripcion as oficina,tipo_asist.descripcion as tipo,sum(num) as num ";
        ...
        String query2 = "CREATE TABLE `tempAJ6a` ( ";
        ...
        String query4 = "select * from tempAJ6";
        ...
        try {
                ...
                while (rs3.next()) {
                  ...
                  query5 = "insert into tempAJ6a values (\""+sAno+"\",\""+tipo+"\","+quantitat1+","+quantitat2+","+quantitat3+","+quantitat4+","+quantitat5+","+quantitat6+")";
